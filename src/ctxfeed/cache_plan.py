...
class CachePlan:
    ...
    def _build_plan(self) -> tuple[ShardPlan, str]:
        ...
        # the user-facing ShardPlan.cache_hit_rate. plan.files counts CHUNKS
        # while plan.delta is a set of HASHES; ``files - len(delta)`` over-
        # reports hits when chunks share a hash (duplicate-content files).
